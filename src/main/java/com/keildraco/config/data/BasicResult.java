...
public final class BasicResult extends ParserInternalTypeBase {
	...
	/**
	 * Internal helper for getting things done in an efficient manner in {@link #getValue()
	 * getValue()}.
	 *
	 * @param value
	 *            The {@link ParserInternalTypeBase} value that we need to convert to a String.
	...
	/**
	 * Override of {@link ParserInternalTypeBase#getValue()} so that it returns all the values it
	 * contains, as formatted by their own getValue() overrides, separated by System specific
	 * line-endings.
	 */
	@Override
	...
	/**
	 * Override of {@link ParserInternalTypeBase#getValueRaw()} that is just a wrapper around
	 * {@link #getValue()} as the BasicResult does not have a single value that can be represented
	 * in any other manner.
	 */
	@Override
